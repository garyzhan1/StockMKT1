...
if my_slider:f"stock price changes by {my_slider * 4.28% + my_slider2 * 0.98% + my_slider3 * 0.55% + my_slider4 * 0.1% +  my_slider5 * 4.2% + 0} when having {my_slider3} minor updates"
